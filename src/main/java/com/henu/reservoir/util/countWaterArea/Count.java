...
public class Count {
	...
	private double lat_north;//图像的北纬度
	private double lat_south;//图像的南纬度
	private double lng_west;//图像的西经度
	private double lng_east;//图像的东经度

	public Count(double lat_north, double lat_south, double lng_west, double lng_east) {
	...
	public String getWaterArea(String path) {
		...
		/*double lat_north = 33.071;//图像的北纬度
		double lat_south = 32.447;//图像的南纬度
		double lng_west = 111.000;//图像的西经度
		double lng_east = 111.775;//图像的东经度*/
